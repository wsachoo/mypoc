package com.att.salesexpress.webapp.entity.postgres;
...
@NamedQueries({ @NamedQuery(name = "SalesRulesPostgreSql.findAll", query = "SELECT s FROM SalesRulesPostgreSql s") })
public class SalesRulesPostgreSql implements Serializable {
