					...
					<div id="serviceFeaturesTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade" id="addServices"
							...
							<div class="" id="addServiceFeatures" style="display: inline;">
								<label for="name">Add Service Name : <input type="text"
									id="addService" name="serviceName" class="form-control"></label>
								<br> <input type="button" value="Add Features"
									id="btnAddFeatures" name="btnAddFeatures"
									class="btn btn-primary"> <br>
							</div>
							<br>
							<div id="divBtnSaveService" class="col-sm-offset-11">
								<input type="button" value="Save Service" id="btnSaveService"
									name="btnSaveService" class="btn btn-primary">
							</div>
						</div>
						...
						<div role="tabpanel" class="tab-pane fade" id="deleteServices"
							...
							<div class="" id="deleteServices" style="display: inline;">
								<label for="name">Enter Service Name To be Deleted:<input
									type="text" id="labelDeleteService" name="labelDeleteService"
									class="form-control"></label> <input type="button"
									value="Delete Service" id="btnDeleteService"
									name="btnDeleteService" class="btn btn-primary"> <br>
							</div>
						</div>
