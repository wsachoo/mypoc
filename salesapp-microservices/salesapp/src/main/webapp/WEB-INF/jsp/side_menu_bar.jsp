...
<div class="nav-side-menu" id="sales_side_bar">
	...
	<c:forEach items="${userSitesData.siteAddresses}" var="objUserSite"> 
		<ul id="menu-content" class="menu-content collapse out">
			<li class="heading1" style="background-color: #777">	
					&nbsp;
					<input type="checkbox" value="${objUserSite.SITE_ID}" data-name="${objUserSite.SITE_NAME}">	
					<a data-toggle="collapse" data-target="#sub_${objUserSite.SITE_ID}"  class="">											
						&nbsp;
						<span class="more-less glyphicon glyphicon-plus" style="color:#fff;font-size: 12px;"></span>
						<span class="sachlefnavheaderspaces" style="display: inline;color:#fff;font-family: FontAwesome;font-size: 18px;">${objUserSite.SITE_NAME}</span>
					</a>
			...
			<div id ="sub_${objUserSite.SITE_ID}" class ="collapse">
				...
				<li data-toggle="collapse" data-target="#available_products_${objUserSite.SITE_ID}" class="collapsed cls_available_products">
					<a href="#">
						<span class="sachlefnavheaderspaces"></span>
						<span class="glyphicon glyphicon-plus"></span>
